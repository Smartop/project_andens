<div class="modal fade bd-profile-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myProfileModalLabel" aria-hidden="true">
                ...
                <div class="row justify-content-center">
                                <form method="POST" action="/editProfile">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="nickname" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                                   name="nickname" value="{{ Auth::user()->nickname }}" maxlength="15"
                                                   required autofocus>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="real_name" id="real_name"
                                                   value="{{ Auth::user()->real_name }}" maxlength="40">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <textarea class="form-control" cols="30" rows="3" maxlength="100"
                                                      placeholder="Write about yourself" name="bio" id="bio">{{ Auth::user()->bio }}
                                </textarea>
                                        </div>
                                    </div>
